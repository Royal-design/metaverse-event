        ...
        <div className="max-w-7xl px-8 md:px-20 py-12 mx-auto">
          ...
          >
            ...
            >
              ...
              <p className="text-gray-300">
                To build a collaborative space where future-defining
                technologies and creative expression converge, empowering every
                voice in the evolving digital universe.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <p className="text-gray-300">
                A fully decentralized, inclusive, and immersive digital
                ecosystem where boundaries fade and innovation thrives
                redefining how we connect, learn, work, and create.
              </p>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed md:text-center max-w-4xl mx-auto">
              ...
              Whether you’re a curious explorer, a digital nomad, or a future
              tech leader, this is your stage.
            </p>
          </motion.div>
        </div>
      </section>
