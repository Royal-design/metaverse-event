    ...
    <section className="min-h-screen  text-white">
      <div className="h-[20rem] w-full max-sm:h-full relative">
        ...
        <article className="absolute   max-sm:px-4 inset-0 bg-gradient-to-br from-black to-[#27042770]  flex flex-col gap-4 items-center justify-center">
          <h1 className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 via-pink-500 to-yellow-400">
            Let’s Connect
          </h1>
          <p className="mt-4 text-lg text-center max-w-2xl mx-auto text-gray-400">
